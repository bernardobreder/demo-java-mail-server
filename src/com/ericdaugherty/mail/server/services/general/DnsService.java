/******************************************************************************
 * $Workfile: DnsService.java $ $Revision: 98 $ $Author: edaugherty $ $Date:
 ...
 * <p>
 * The current version of this class depends on the org.xbill.DNS libraries to
 * perform DNS Lookups.
 * 
...
public class DnsService {
	...
	/**
	 * This method returns an array of addresses that represent MX Entries for
	 * the specified domain. If no MX entries were found for the specified
	 * domain, and empty array is returned.
	 * 
	 * @param domain
	 *            the domain perform the MX Lookup on.
	 */
	public static String[] getMXEntries(String domain) {
		...
		for (int index = 0; index < numEntries; index++) {
			addresses[index] = ((MXRecord) records[index]).getTarget()
					.toString();
		}
		return addresses;
	}
