...
public class Mail {
  ...
  /**
   * Logger Category for this class. This variable is initialized once the main
   * logging system has been initialized
   */
  ...
  /**
   * Provides a 'safe' way for the application to shut down. It will attempt to
   * stop the running threads. If the threads to not stop within 60 seconds, the
   * application will force the threads to stop by calling System.exit();
   */
   ...
   * initial configuration of the application and the creation of all 'service'
   * threads.
   */
  ...
  /**
   * Parses the input parameter for the configuration directory, or defaults to
   * the local directory.
   *
   ...
   * this application. All required information is loaded from the configuration
   * file.
   */
   ...
   * found.
   *
   * @param logConfigurationFile the file that may contain properties to use to
