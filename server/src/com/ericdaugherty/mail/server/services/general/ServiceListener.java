/******************************************************************************
 * $Workfile: ServiceListener.java $ $Revision: 144 $ $Author: edaugherty $
...
/**
 * This class listens for incoming connections on the specified port and starts
 * a new thread to process the request. This class abstracts common functinality
 * required to start any type of service (POP3 or SMTP), reducing the
 * requirement to duplicate this code in each package.
 *
...
public class ServiceListener implements Runnable {
  ...
  /**
   * Entry point for the thread. Listens for incoming connections and start a
   * new handler thread for each.
   */
  public void run() {
