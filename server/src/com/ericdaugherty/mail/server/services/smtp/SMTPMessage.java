...
public class SMTPMessage implements Serializable {
   ...
   * @throws IOException thrown if there is any IO error while reading the
   *         message.
   */
  ...
  /**
   * Converts a <code>List</code> of <code>EmailAddress</code> instances into a
  ...
  /**
   * Converts a comma delimited string of addresses into a <code>List</code> of
