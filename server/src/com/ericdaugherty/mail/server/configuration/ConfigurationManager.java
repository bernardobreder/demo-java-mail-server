...
public class ConfigurationManager implements ConfigurationParameterContants {
   ...
   *
   * @param generalConfigurationFile the file to load the general configuration
   *        from.
   ...
   * method should only be called once during startup, and then never again. The
   * file path can not be re-initialized!
   *
   * @param configurationDirectory the directory that contains mail.conf and
   *        user.conf
   ...
   * @return a String[] of the values, or an empty array if the key could not be
   *         found.
   */
  ...
  /**
   * Creates a new User instance for the specified username using the specified
   * properties.
   *
