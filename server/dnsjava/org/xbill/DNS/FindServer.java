 ...
 * appropriate properties are set, the OS has a unix-like /etc/resolv.conf, or
 * the system is Windows based with ipconfig or winipcfg. There is no reason for
 * these routines to be called directly except curiosity.
 *
 * As of dnsjava 1.6.6, all functions in this class are wrappers around
 * functions in the ResolverConfig class, and those should be used instead.
 *
 * @see ResolverConfig
 *
