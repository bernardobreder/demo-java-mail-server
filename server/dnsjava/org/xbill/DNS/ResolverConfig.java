 ...
 * to unqualified names. Currently, this works if either the appropriate
 * properties are set, the OS has a unix-like /etc/resolv.conf, or the system is
 * Windows based with ipconfig or winipcfg. These routines will be called
 * internally by the Lookup class, and can also be called directly if desired.
 *
