 ...
 * <P>
 * As of dnsjava 1.4.0, all functions in this class are wrappers around
 * functions in the Lookup and ReverseMap class, and those should be used
 * instead.
 *
 * @see Lookup
 * @see ReverseMap
...
public final class dns {
  ...
  /**
   * Obtains the Cache used by functions in the dns class. This can be used to
   * perform more specific queries and/or remove elements.
   *
  ...
  /**
   * Obtains the (class IN) Cache used by functions in the dns class. This can
   * be used to perform more specific queries and/or remove elements.
   */
